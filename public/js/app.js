...
function load() {
  ...
  if (!r && typeof process !== 'undefined' && 'env' in process) {
    r = Object({"MIX_PUSHER_APP_KEY":"6986249290c0d2c87f96","MIX_PUSHER_APP_CLUSTER":"ap2","NODE_ENV":"development"}).DEBUG;
  }
...
Vue.component('passport-clients', __webpack_require__(80));
...
window.io = __webpack_require__(55);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0), __webpack_require__(78).setImmediate))
...
var update = __webpack_require__(13)("2a28cc49", content, false, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(13)("10846595", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(13)("4e7bd74e", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
