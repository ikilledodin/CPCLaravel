...
<html class="full-height" lang="en-US">
  <head>
    ...
    <link href="{!! asset('home/styles/main.css') !!}" rel="stylesheet">
  </head>
  <body id="top">
    <header>
      <!-- Navbar-->
      <nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar" id="navbar">
        <div class="container"><a class="navbar-brand" href="#"><strong>HealthQuest</strong> by TupeloLife</a>
          ...
          <div class="collapse navbar-collapse" id="navbarContent">
            ...
            </ul><a class="btn btn-primary btn-rounded my-0" href="/login">Login</a>
          </div>
        </div>
      </nav>
      <!-- Intro Section-->
