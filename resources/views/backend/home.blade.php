        ...
        <div class="row clearfix">
             <div class="col-md-12">
                ...
                <div class="list-group">
                    ...
                    <div class="row-content">
                        <div class="action-secondary"><i class="material-icons">settings</i></div>
                        <h4 class="list-group-item-heading">OAuth Settings</h4>
                        <a href="admin/tokenmanager" class="btn btn-default btn-raised">Check Settings</a>
                    </div>
                    <div class="list-group-separator"></div>
                    </div>
                </div>
